...
export default function Userinfo() {
  ...
  function handleSubmit(e) {
    ...
    axios
      .post(`${baseURL}api/users/updateinfo`, inputs)
      .then((res) => {
        console.log(res);
        if (res.status === 200) {
            ...
            <Fade>
              <div className="userInfo-split">
                <div>
                  ...
                  <div>
                    <Link to="#"> Recieve Alerts on Mail</Link>{" "}
                  </div>
                  <div>
                    <Link to="#"> Recieve Notifications</Link>{" "}
                  </div>
                </div>
                <div>
                  <div> Funds </div>
                  ...
                  <div>
                    <Link to="#"> Request More Virtual Money </Link>
                  </div>
