...
export default function Signup() {
  ...
  const [displayUserAlreadyExsits, setDisplayUserAlreadyExsits] =
    useState(false);
  ...
  const { name, email, password, confirmPassword, proffession, dob, phone } =
    inputs;
        ...
        <div className="section-wrapper">
            ...
            <div className="signup-form-wrapper">
              <div className="signup-form-div">
                <form method="POST" onSubmit={handleSubmit}>
                      ...
                      <>
                        ...
                        <div className="form-credentials checkbox-agree-hidden">
                          <div>
                            <input
                              type="checkbox"
                              className="checkbox-agree-input"
                              name="agreeTnc"
                  ...
                  <div className="login-option-onSignup">
                    Or, I am already a Member ? &nbsp;
                    <Link to="/signin">Login here</Link>
                  </div>
                </form>
              </div>

              {displayUserAlreadyExsits ? (
                <div className="wrong-credentials-signup">
          ...
          <Fade right>
            <div className="signup-img">
              <div className="signup-lottie" ref={container}></div>
              <div>
