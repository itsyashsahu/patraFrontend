...
export default function Watchlist() {
  ...
  const removeStock = async (stockSymbol) => {
    try {
      ...
      axios
        .post(`${baseURL}api/watchlist/remove`, removeStockData)
        .then((res) => {
                  ...
                  <>
                    <Fade top>
                      <div className="watchlist-item">
                        <span
                          className={`watchlist-items-label ${watchlistdata[index]["stockEndedIn"]}`}
                        >
                            ...
                            onClick={() => {
                              if (option === "sell") {
                                ...
                                var clickedStockData = {
                                  ...
                                  stockSymbol:
                                    watchlistdata[index]["stockSymbol"],
                        ...
                        <span
                          className={` ${watchlistdata[index]["stockEndedIn"]}`}
                        >
                          ₹{watchlistdata[index]["close"]}
                        </span>
                        <span className="watchlist-items-number">
                          <span
                            className={`watchlist-items-number-change ${watchlistdata[index]["stockEndedIn"]}`}
                          >
                            {watchlistdata[index]["change"]}
                          </span>
                          <Link
                            onClick={() =>
                              removeStock(watchlistdata[index]["stockSymbol"])
                            }
                            to="#"
                          >
                            <svg
      ...
      <div>
        <Fade left>
          <div className="watchlist-item-caution numberFont">
            The Api supports only 5 calls per minute please make sure your
            holdings and watchlist combined have 5 entries to ensure proper
            working. The Prices will update next working day.
          </div>
          <div className="watchlist-nav">
            <div className="watchlist-nav-items">
              <Link to="#">1</Link>
            </div>
            <div className="watchlist-nav-items">
              <Link to="#">2</Link>
