...
export default function Modal() {
  ...
  async function handleSubmit(e) {
    ...
    if (
      option === "buy" &&
      qty > 0 &&
      user.fundsAvailable >= +qty * currPrice
    ) {
      const finalInput = {
        ...inputs,
        price: currPrice,
      ...
      await axios
        .post(`${baseURL}api/holding/trans`, finalInput)
        .then((res) => {
          // console.log(res)
          if (res.status === 200) {
  ...
  if (!isOrderExecuted) {
                    ...
                    {stockData.option === "buy" ? (
                      <>
                        ...
                        <span>
                          ...
                          <p className="numberFont">
                            &nbsp;&nbsp;₹&nbsp;
                            {Math.round(user.fundsAvailable * 100) / 100}
                          </p>{" "}
                        </span>
                        <span>
                          ...
                          <p className="numberFont">
                            &nbsp;&nbsp;₹&nbsp;
                            {Math.round(
                              (user.fundsAvailable - qty * currPrice) * 100
                            ) / 100}
                          </p>{" "}
                        </span>
                      </>
                      ...
                      <>
                        <span>
                          ...
                          <p className="numberFont">
                            {stock
                              ? stock.qty
                              : "0 You Cannot Execute This Transaction"}
                          </p>{" "}
                        </span>
                        <span>
                          Ttl. Sell Value :{" "}
                    ...
                    <span className="orderType-extras">
                        ...
                        <>
                          <span>
                            <input
                              type="checkbox"
                              name="setYourTarget"
                              value={valueCheckbox ? false : true}
                              onChange={handleChange}
                              disabled
                            />
                      ...
                      {isFieldsSet && (
                        <span className="orderType-fill-all-fields">
                          <i className="ri-error-warning-line"></i>Please fill
    ...
    return (
      <Draggable>
        <div className="drag-wrapper">
          <div className="lottie-modal-buy" ref={container1}></div>
        </div>
      </Draggable>
    );
  }
